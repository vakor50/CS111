 ...
 *
 *   Returns -1 if new thread fails
 *   Returns 0 to new thread if successful
 *   Returns pid of new process to the parent process
 *
 *****************************************************************************/
 ...
 *   Returns 0 to current thread if successful
 *   Returns -1 if failed
 *
 *****************************************************************************/
